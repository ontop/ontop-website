...
Access the SPARQL endpoint. Open <http://localhost:8080/>, and run an example SPARQL query:
 ...
 ```
 you can obtain the following certain answers which are generated from the data extracted from both uni1 and uni2:
 ```
